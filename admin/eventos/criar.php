...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!verificarCSRFToken($_POST['csrf_token'] ?? '')) {
        ...
        // Gerar slug único
        $dados['slug'] = slugifyUnique($dados['titulo'], 'eventos');
        ...
        // Se não houver erros de upload, validar dados do evento
        if (empty($erros)) {
            try {
                ...
                header('Location: /admin/eventos/index.php?msg=criado');
                exit;
            } catch (Exception $e) {
                $erros[] = $e->getMessage();
            }
                ...
                <div class="card-body">
                    <?php if (!empty($erros)): ?>
                        <div class="alert alert-error">
                            <strong>❌ Erro ao criar evento:</strong>
                    ...
                    <form method="POST" enctype="multipart/form-data" class="admin-form">
                        ...
                        <div class="alert alert-warning" style="margin-bottom: 1rem;">
                            <strong>⚠️ ATENÇÃO:</strong> A imagem deve ter <strong>EXATAMENTE 475x180 pixels</strong>.<br>
                            Imagens com dimensões diferentes serão <strong>rejeitadas</strong>.
                        </div>

                        <div class="form-group">
                            <label for="imagem_destaque" class="required">Upload de Imagem (475x180px)</label>
                            <input type="file"
                                   id="imagem_destaque"
