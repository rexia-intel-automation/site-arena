...
<head>
    ...
    <meta name="description" content="Página não encontrada - Arena BRB Mané Garrincha">
    <meta name="robots" content="noindex, nofollow">

    <title>404 - Página não encontrada | Arena BRB</title>
    ...
    <style>
        ...
        .error-code {
            ...
            font-weight: 900;
            line-height: 1;
            background: linear-gradient(135deg, var(--brb-blue) 0%, var(--cyan) 100%);
...
<body>
    ...
    <div class="error-container">
        ...
        <p class="error-description">
            Ops! Parece que você se perdeu no complexo. A página que você está procurando não existe ou foi movida para outro lugar.
        </p>
        ...
        <div class="error-actions">
            ...
            <a href="/eventos" class="error-btn error-btn-secondary">
                <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <div class="error-suggestions">
            ...
            <div class="suggestions-list">
                <a href="/eventos" class="suggestion-item">
                    ...
                    <div class="suggestion-content">
                        <h4>Eventos</h4>
                        <p>Confira os próximos shows e jogos</p>
                    </div>
                </a>

                <a href="/espacos" class="suggestion-item">
                    <div class="suggestion-icon">
                        <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    ...
                    <div class="suggestion-content">
                        <h4>Espaços</h4>
                        <p>Conheça nossos espaços multiuso</p>
                    </div>
                </a>

                <a href="/noticias" class="suggestion-item">
                    <div class="suggestion-icon">
                        <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <a href="/contato" class="suggestion-item">
                    <div class="suggestion-icon">
                        <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
